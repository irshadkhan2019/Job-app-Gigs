...
import { IHitsTotal, IPaginateProps, IQueryList, ISearchResult } from '@irshadkhan2019/job-app-shared';

// gets active and inactive gigs of a particular seller based on active boolean field.
...
// gets similar gigs like the provide gigId
...
//calculate ratingssum/ratings count if rc is !=0
//if after the calculation rating is equal to threshold then only returns the document
//doc obj has all properties of _source
