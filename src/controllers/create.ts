...
import { BadRequestError, ISellerGig, uploads } from '@irshadkhan2019/job-app-shared';
...
//   upload cover image to cloudinary and results secure_url stored in db and ES
